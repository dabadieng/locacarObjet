...
/**
Autoload : 
- les controleurs sont dans le répertoire _module, le fichier est préfixé par "Ctr_"
- les classes entity sont dans le répertoire "_entity"
*/
function monAutoLoad($classname) {
	if ("Ctr_" == substr($classname, 0, 4)) {
        ...
        require_once "../_entity/" . $classname . ".class.php";
    }	
}
...
/**
Traitement des chaines anti XSS avant affichage dans une pase HTML.
*/
function mhe($x) {
